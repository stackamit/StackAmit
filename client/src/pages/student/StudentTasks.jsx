        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4" onClick={() => setShowSubmit(null)}>
          <div className="bg-white dark:bg-dark-800 rounded-2xl shadow-xl w-full max-w-md p-6" onClick={e => e.stopPropagation()}>
            ...
            <form onSubmit={handleSubmitTask} className="space-y-4">
              ...
              {/* Google Form Link */}
              {/* <div className="pt-2"><p className="text-sm text-gray-600 mb-2">After submitting your task, please complete the task submission form:</p><a href="https://forms.gle/Kie25KvB2yMLHyyd6" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 font-medium underline">📋 Open Task Submission Google Form </a></div> */}
